...
<%@page import="com.towcent.base.sc.web.common.web.Servlets"%>
<%@page import="com.towcent.base.common.utils.Exceptions"%>
<%@page import="com.towcent.base.sc.web.common.utils.StringUtils"%>
...
<body>
	<div class="container-fluid">
		...
		<br/> <br/>
		<script>try{layer.close();}catch(e){}</script>
	</div>
</body>
</html>
<%
