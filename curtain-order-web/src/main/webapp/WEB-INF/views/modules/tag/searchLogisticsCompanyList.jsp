...
<body>
	...
	<form:form id="searchForm" modelAttribute="sysLogisticsCompany" action="${ctx }/sys/sysLogisticsCompany/searchLogisticsCompanyList" method="post" class="navbar-form form-search">
		...
		<ul class="ul-form">
			<li><label>物流公司编码：</label>
				<form:input path="companyNo" htmlEscape="false"  class="form-control"/>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<tbody id="tbody_id">
		<c:forEach items="${page.list}" var="company" varStatus="vs">
			<tr>
				<td>
					<input type="radio" name="completeCheck" id="${company.id}" value="${company.companyName}"/>
				</td>
				<td>
					${company.companyNo}
				</td>
