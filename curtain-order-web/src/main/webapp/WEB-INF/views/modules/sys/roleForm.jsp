...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			...
			<span class="help-block"><font color="red">*</font> 工作流用户组标识</span>
		</div>
		<input type="hidden" name="roleType" id="roleType" value="user"/>
		<%-- <div class="form-group">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<form2:radiobuttons path="sysData" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" />
		...
		<div class="form-group">
			<div class="col-sm-5 col-sm-offset-2">
				<c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}">
					<shiro:hasPermission name="sys:role:edit"><button id="btnSubmit" type="submit" class="button big">保 存</button>&nbsp;</shiro:hasPermission>
				</c:if>
