...
<head>
    ...
    <script type="text/javascript">
	    $(document).ready(function(){
			...
			$('input[name=completeCheck][value="${merchantInfo.merchantNo}"]').attr("checked","chekced");
		});
...
<body>
	...
	<form id="searchForm" action="${ctx}/merchant/merchantInfo/searchlist" method="post">
		<div style="padding: 1px;">
			<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
			<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
			<input type="hidden" name="merchantStatus" maxlength="100" class="input-medium" value="${merchantInfo.merchantStatus }"/>
			<label>店铺编码：</label>
		...
		<tbody id="tbody_id">
			...
			<tr style="cursor: pointer;">
				<td style="text-align:center;">${i.index + 1}
					<input type="radio" name="completeCheck" value="${obj.merchantNo }">
				</td>
