...
<body>
	...
	<div id="search" style="padding:2px 2px 0 2px;">
		<div class="input-group">
			<input type="text" class="empty form-control" id="key" name="key" maxlength="50" placeholder="关键字">
			<div class="input-group-btn">
				<button class="btn btn-default" id="btn" onclick="searchNode()"><i class="icon-search"></i></a></button>	
			</div>
		</div>
	</div>
