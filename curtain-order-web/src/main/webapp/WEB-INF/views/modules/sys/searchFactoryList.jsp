	    ...
	    $(document).ready(function(){
			$('tbody tr').each(function() {
				...
				$(this).dblclick(function(){
					...
					parent.$('#repairFactoryId').val(id);
					parent.$('#repairFactoryIds').val(val);
...
<body>
	...
	<form:form id="searchForm" modelAttribute="baseSupplierInfo" action="${ctx }/tag/tagSearch/searchFactoryList" method="post" class="navbar-form form-search" role="form">
