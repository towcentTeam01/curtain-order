...
<body>
	...
	<form:form id="searchForm" action="${ctx}/sys/log/" method="post" class="navbar-form form-search">
		...
		<ul class="ul-form">
			...
			<li>
				<div class="checkbox abc-checkbox">
                    <input id="exception" name="exception" class="styled" type="checkbox" ${log.exception eq '1'?' checked':''} value="1">
             		<label for="exception" style="line-height: 18px;">
               			只查询异常信息
                    </label>
                </div>
			</li>
