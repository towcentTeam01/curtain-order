...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/mall/concernGoods/">商品收藏列表</a></li>
		<%-- <shiro:hasPermission name="goods:concernGoods:edit"><li><a href="${ctx}/goods/concernGoods/form">关注商品添加</a></li></shiro:hasPermission> --%>
	</ul>
	<form:form id="searchForm" modelAttribute="concernGoods" action="${ctx}/mall/concernGoods/" method="post" class="navbar-form form-search" role="form">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="concernGoods">
			<tr>
			    <td>
			        <img style="width: 100px;height: 100px; object-fit: contain;" src="${concernGoods.goods.goodsPicUrl}"/>
			    </td>
				<td>
				...
				<td>
					...
					<a href="${ctx}/mall/concernGoods/delete?id=${concernGoods.id}" onclick="return confirmx('确认要删除该关注商品吗？', this.href)">删除</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
