...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/sys/consigneeAddr/">收货地址列表</a></li>
		<shiro:hasPermission name="sys:consigneeAddr:edit"><li><a href="${ctx}/sys/consigneeAddr/form">收货地址添加</a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="consigneeAddr" action="${ctx}/sys/consigneeAddr/" method="post" class="navbar-form form-search" role="form">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>会员名称</th>
				<th>更新时间</th>
				<shiro:hasPermission name="sys:consigneeAddr:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="consigneeAddr">
			<tr>
				...
				<shiro:hasPermission name="sys:consigneeAddr:edit"><td>
    				<a href="${ctx}/sys/consigneeAddr/form?id=${consigneeAddr.id}">修改</a>
					<a href="${ctx}/sys/consigneeAddr/delete?id=${consigneeAddr.id}" onclick="return confirmx('确认要删除该收货地址吗？', this.href)">删除</a>
