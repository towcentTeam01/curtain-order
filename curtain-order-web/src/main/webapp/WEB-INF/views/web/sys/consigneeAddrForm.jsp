...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/consigneeAddr/">收货地址列表</a></li>
		<li class="active"><a href="${ctx}/sys/consigneeAddr/form?id=${consigneeAddr.id}">收货地址<shiro:hasPermission name="sys:consigneeAddr:edit">${not empty consigneeAddr.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:consigneeAddr:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="consigneeAddr" action="${ctx}/sys/consigneeAddr/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-group">
			...
			<shiro:hasPermission name="sys:consigneeAddr:edit">
