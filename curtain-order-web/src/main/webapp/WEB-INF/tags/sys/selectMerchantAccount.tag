...
<input type="text" id="${id}" name="${name}" placeholder="商家帐号" value="${value}" class="${cssClass}" style="width:150px;" 
...
<script type="text/javascript">
	$("#${id}Button").click(function(){
		var val = $('#${name}').val();
		top.$.jBox.open("iframe:${ctx}/merchant/merchantAccount/selMerchantAccount?merchantAccount="+val, "选择商家", 800, $(top.document).height()-180, {
