...
<input type="text" id="${id}" name="${name}" placeholder="店铺编码" value="${value}" class="${cssClass}" style="width:150px;" 
...
<script type="text/javascript">
	$("#${id}Button").click(function(){
		var val = $('#${name}').val();
		top.$.jBox.open("iframe:${ctx}/merchant/merchantInfo/selMerchantNo?merchantNo="+val, "选择店铺", 800, $(top.document).height()-180, {
